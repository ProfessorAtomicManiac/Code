...
public class GraphTest {
    ...
    {
        LinkedList<Integer> vertices = graph.vertices();
        ...
        LinkedList<AdjacencyList.Edge<Integer, Character>> edges = graph.edges();
    ...
    public void testAdjacencyList3()
    {
        ...
        LinkedList<AdjacencyList.Edge<Integer, Character>> edges = graph.outgoingEdges(3);
